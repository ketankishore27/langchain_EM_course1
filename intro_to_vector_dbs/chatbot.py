...
retrieval_agent = get_rag_agent(model = "gpt-4o-mini", index_name = "langchain-chabot", embeddings = "text-embedding-3-small")
...
for user_query, generated_response in zip(st.session_state.user_query, st.session_state.bot_response):
...
if input_question:
    ...
    with st.spinner("Wait for it..."):
        ...
        answer = retrieval_agent.invoke({"input": input_question, "chat_history": st.session_state.chat_history})['answer']
